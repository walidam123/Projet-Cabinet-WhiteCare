...
public class PDFGenerator {
    ...
    public static byte[] generateOrdonnancePDF(
        ...
        if (prescriptions != null && !prescriptions.isEmpty()) {
            ...
            for (PrescriptionInfo prescription : prescriptions) {
                ...
                table.addCell(new Cell().add(new Paragraph(String.valueOf(prescription.getQuantite()))));
                table.addCell(new Cell().add(new Paragraph(prescription.getFrequence() != null ? prescription.getFrequence() : "")));
                table.addCell(new Cell().add(new Paragraph(String.valueOf(prescription.getDureeEnJours()))));
            }
    ...
    public static byte[] generateFacturePDF(
        ...
        table.addCell(new Cell().add(new Paragraph(String.format("%.2f", totaleFacture != null ? totaleFacture : 0.0)))
                .setTextAlignment(TextAlignment.RIGHT));

        table.addCell(new Cell().add(new Paragraph("Total payé")));
        table.addCell(new Cell().add(new Paragraph(String.format("%.2f", totalePaye != null ? totalePaye : 0.0)))
                .setTextAlignment(TextAlignment.RIGHT));

        table.addCell(new Cell().add(new Paragraph("Reste à payer").setBold()));
        table.addCell(new Cell().add(new Paragraph(String.format("%.2f", reste != null ? reste : 0.0)).setBold())
                .setTextAlignment(TextAlignment.RIGHT)
                .setBackgroundColor(ColorConstants.LIGHT_GRAY));
