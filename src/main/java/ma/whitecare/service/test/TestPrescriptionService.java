        ...
        try {
            ...
            for (PrescriptionDTO p : allPrescriptions) {
                System.out.println("  - Prescription ID: " + p.getIdPr() +
                        ...
                        ", Durée: " + p.getDureeEnJours() + " jours" +
                        ", Fréquence: " + p.getFrequence());
            }
            ...
            System.out.println("  Quantité: " + created.getQuantite());
            System.out.println("  Fréquence: " + created.getFrequence());
            System.out.println("  Durée: " + created.getDureeEnJours() + " jours");
            ...
            System.out.println("  Nouvelle durée: " + updated.getDureeEnJours() + " jours");
